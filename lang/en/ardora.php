...
$string['cachedef_courseid_cache'] = 'Cache for soring IDs of courses in session.';
...
$string['courseidnotfound'] = "Course identifier not found.";
...
$string['modulename_help'] = 'Explanatory help here';
