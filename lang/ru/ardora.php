...
$string['ardora:grade'] = 'Оценить доставку Ardora';
...
$string['cachedef_courseid_cache'] = 'Кэш для хранения идентификаторов курсов в сессии.';
...
$string['completionpassgrade'] = 'Студент должен набрать проходной балл для завершения этой активности.';
$string['completionpassgrade_help'] = 'Если эта опция включена, активность будет считаться выполненной только в случае, если студент достигнет установленного проходного балла.';
...
$string['courseidnotfound'] = 'Идентификатор курса не найден.';
...
$string['gradingoptions'] = 'Параметры оценки';
...
$string['invalidpassinggrade'] = 'Проходной балл должен быть числом от 0 до 100.';
...
$string['maximumgrade_help'] = 'Укажите максимальную оценку, которую можно получить за эту деятельность.';
...
$string['passinggrade'] = 'Одобренный';
$string['passinggrade_help'] = 'Минимальная оценка, которую должен получить пользователь, чтобы считать задание пройденным.';
...
$string['popupheight_desc'] = 'Высота всплывающего окна по умолчанию (в пикселях).';
...
$string['popupwidth_desc'] = 'Ширина всплывающего окна по умолчанию (в пикселях).';
