...
$string['configpopup'] = 'Ardora berri bat gehitzean, leiho gainerakor batean bistaratzeko gai dena, aukera hau lehenetsita egon behar al du?';
$string['configpopupdirectories'] = 'Leiho gainerakorrek lehenetsita direktorioen estekak erakutsi behar al dituzte?';
$string['configpopupheight'] = 'Zein altuera izan behar luke leiho gainerakor berrien lehenetsitako altuerak?';
$string['configpopuplocation'] = 'Leiho gainerakorrek lehenetsita kokapen barra erakutsi behar al dute?';
$string['configpopupmenubar'] = 'Leiho gainerakorrek lehenetsita menuko barra erakutsi behar al dute?';
$string['configpopupresizable'] = 'Leiho gainerakorrek lehenetsita tamaina alda al daitezke?';
$string['configpopupscrollbars'] = 'Leiho gainerakorrek lehenetsita korritzeko barrak izan behar al dituzte?';
$string['configpopupstatus'] = 'Leiho gainerakorrek lehenetsita egoera barra erakutsi behar al dute?';
 ...
 * Automatikoa - Fitxategi motarako bistaratzeko aukera egokiena automatikoki hautatzen da
 * Txertatu - Fitxategia orrian bistaratu daiteke, nabigazio barraren azpian, fitxategiaren deskribapenarekin eta blokeekin batera
 * Deskarga behartu - Erabiltzaileari fitxategia deskargatzeko eskaera egiten zaio
 * Ireki - Fitxategia bakarrik erakusten da nabigatzailearen leihoan
 * Leiho gainerakorrean - Fitxategia nabigatzailearen leiho berri batean bistaratzen da, menurik edo helbide barrarik gabe
 * Markoan - Fitxategia marko batean bistaratzen da, nabigazio barraren eta fitxategiaren deskribapenaren azpian
 * Leiho berrian - Fitxategia nabigatzailearen leiho berri batean bistaratzen da, menu eta helbide barrarekin';
...
$string['filterfilesexplain'] = 'Hautatu fitxategiaren edukia iragazteko mota, kontuan izan honek arazoak sor ditzakeela Flash eta Java applet batzuekin. Ziurtatu testu-fitxategi guztiak UTF-8 kodifikazioan daudela.';
...
$string['indicator:cognitivedepthdef_help'] = 'Parte-hartzaileak lortutako konpromiso kognitiboaren portzentajea da, fitxategi ardora-k eskaintzen duena, analisi-aldian zehar (Mailak = Ikusmena ez, Ikusmena)';
$string['indicator:cognitivedepthdef_link'] = 'Learning_analytics_indicators#Cognitive_depth';
$string['indicator:socialbreadth'] = 'Fitxategiaren sakontasun soziala';
$string['indicator:socialbreadth_help'] = 'Adierazle hau ikasleak fitxategi ardora batean lortutako sakontasun sozialean oinarritzen da.';
...
$string['showdate_desc'] = 'Ikastaroko orrian kargatze/aldatze data erakutsi?';
$string['showdate_help'] = 'Kargatze/aldatze data erakusten du fitxategiaren esteken ondoan.
...
Ardora honetan fitxategi bat baino gehiago badago, fitxategi nagusiaren mota erakusten da.
